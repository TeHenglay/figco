        ...
        <div class="max-w-xl" x-data="pollStatus('{{ route('homework.status', $homework) }}', '{{ route('homework.timeout', $homework) }}', '{{ csrf_token() }}')" x-init="startPolling()">
            <div class="bg-white border-2 border-slate-900 pixel-shadow-lg">
                ...
                <div class="p-10 flex flex-col items-center text-center">
                    ...
                    <h3 class="font-headline-md text-headline-md text-slate-900 mb-2" style="font-family: Epilogue, sans-serif;">{{ __('AI is generating your homework') }}</h3>
        ...
        <div class="max-w-xl">
            <div class="bg-white border-2 border-red-600 pixel-shadow">
                ...
                <div class="p-8 flex flex-col items-center text-center">
                    ...
                    <h3 class="font-headline-md text-headline-md text-slate-900 mb-2" style="font-family: Epilogue, sans-serif;">{{ __('Generation Failed') }}</h3>
                ...
                <div class="bg-white border-2 border-slate-900 pixel-shadow">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex flex-wrap gap-1.5 mb-3">
                            @foreach([
                                __('Add 5 more questions'),
                                __('Add an answer key'),
                                __('Make questions harder'),
                                __('Add a vocabulary section'),
                                __('Simplify the language'),
                                __('Add a bonus challenge question'),
                            ] as $chip)
                                <button type="button"
                        ...
                        <textarea
                            x-model="instruction"
                            rows="3"
                            placeholder="{{ __('Tell AI how to improve this homework...') }}"
                        ...
                        <button @click="refine()"
                            ...
                            <span x-text="loading ? '{{ __('Refining...') }}' : '{{ __('Apply Changes') }}'">{{ __('Apply Changes') }}</span>
                        </button>
                    </div>
                </div>
