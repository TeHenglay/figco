    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            @if (Route::has('password.request'))
                <a class="font-technical-xs text-technical-xs text-slate-500 hover:text-slate-800 underline underline-offset-2 transition-colors" href="{{ route('password.request') }}">
